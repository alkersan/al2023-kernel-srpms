...
Source0: linux-6.1.109.tar
Source1: linux-6.1.109-patches.tar
...
Patch0186: 0186-x86-kaslr-Expose-and-use-the-end-of-the-physical-mem.patch
Patch0187: 0187-x86-ioremap-Use-is_ioremap_addr-in-iounmap.patch
Patch0188: 0188-fou-Fix-null-ptr-deref-in-GRO.patch
...
ApplyPatch 0186-x86-kaslr-Expose-and-use-the-end-of-the-physical-mem.patch
ApplyPatch 0187-x86-ioremap-Use-is_ioremap_addr-in-iounmap.patch
ApplyPatch 0188-fou-Fix-null-ptr-deref-in-GRO.patch
...
%changelog
* Sun Sep 08 2024 Builder <builder@amazon.com>
- builder/ca188e9c3f4201df959d8217808549bce258c868 last changes:
  + [ca188e9c] [2024-09-08] Rebase to v6.1.109 (dev@py)

- linux/4e0e6f91797eedfa5d639b1f8ab1587014140304 last changes:
  + [4e0e6f91797e] [2024-08-30] fou: Fix null-ptr-deref in GRO. (kuniyu@amazon.com)
  + [5e78c9e1b55b] [2024-08-15] x86/ioremap: Use is_ioremap_addr() in iounmap() (max8rr8@gmail.com)
  + [971c13dcb9af] [2024-08-14] x86/kaslr: Expose and use the end of the physical memory address space (tglx@linutronix.de)
  + [bd6ee0d1ddef] [2024-04-26] bpf: add mrtt and srtt as BPF_SOCK_OPS_RTT_CB args (lulie@linux.alibaba.com)
  + [4eb67019241f] [2024-08-07] scsi: mpi3mr: Avoid memcpy field-spanning write WARNING (mngyadam@amazon.com)
  + [215103a51054] [2024-08-07] scsi: mpi3mr: Sanitise num_phys (mngyadam@amazon.com)
  + [9ebf789cceb0] [2024-08-07] Add out-of-tree mpi3mr 8.9.1 driver (mngyadam@amazon.com)
  + [a0112a326901] [2024-07-23] dma: Automatically enable page touching on Caspian (dwmw@amazon.co.uk)
  + [e40cf1c64e27] [2021-02-24] drivers/misc: sysgenid: add system generation id driver (acatan@amazon.com)
  + [09f72e264268] [2024-06-13] acpi: Support CONFIG_ACPI without CONFIG_PCI (surajjs@amazon.com)
  + [b9181f34cb7c] [2024-04-17] virt: vmgenid: add support for devicetree bindings (sudanl@amazon.com)
  + [73700fc2bd30] [2024-04-17] virt: vmgenid: change implementation to use a platform driver (sudanl@amazon.com)
  + [d679caae1804] [2024-07-24] ptp: Add vDSO-style vmclock support (dwmw@amazon.co.uk)
  + [85728ad93010] [2024-07-12] AL2023-6.1-Update-ena-driver-to-2.12.3g (akiyano@amazon.com)
  + [7cc108a1bdcf] [2022-12-18] cifs: use origin fullpath for automounts (pc@cjr.nz)
  + [9bc53274f287] [2024-06-05] arm64: mm: Batch dsb and isb when populating pgtables (ryan.roberts@arm.com)
  + [af4c2da32e0c] [2024-06-05] arm64: mm: Don't remap pgtables per-cont(pte|pmd) block (ryan.roberts@arm.com)
  + [57bc0524334c] [2023-07-12] dma-contiguous: support numa CMA for specified node (yajun.deng@linux.dev)
  + [66fdbe1333b2] [2023-05-12] dma-contiguous: support per-numa CMA for all architectures (yajun.deng@linux.dev)
  + [44b409560bcb] [2024-03-11] arm64: acpi: Honour firmware_signature field of FACS, if it exists (dwmw@amazon.co.uk)
  + [93e3f7b22834] [2024-03-11] ACPICA: Detect FACS even for hardware reduced platforms (dwmw@amazon.co.uk)
  + [3cf2ceec619f] [2024-03-11] arm64: Use SYSTEM_OFF2 PSCI call to power off for hibernate (dwmw@amazon.co.uk)
  + [a9a3f92d2a89] [2024-03-18] firmware/psci: Add definitions for PSCI v1.3 specification (ALPHA) (dwmw@amazon.co.uk)
  + [ac3f510851f8] [2024-01-05] x86/sev: Harden #VC instruction emulation somewhat (bp@alien8.de)
  + [631ee600527a] [2024-03-19] AL2023-6.1-Update-ena-driver-to-2.12.0g (evostrov@amazon.com)
  + [f7af0c415b85] [2024-03-09] Initial 2.15 Lustre client commit (jacwolf@amazon.com)
  + [b2c19c3e29a5] [2024-03-09] Config glue for 2.15 Lustre client (jacwolf@amazon.com)
  + [b60ad5e620b0] [2024-02-20] AL2023 6.1 Update EFA driver to 2.8.0 (mrgolin@amazon.com)
  + [39955b8fe53b] [2024-02-07] AL2023-6.1-Update-ena-driver-to-2.11.1g (darinzon@amazon.com)
  + [71d52b6e1ecc] [2023-01-31] arm64: pauth: don't sign leaf functions (mark.rutland@arm.com)
  + [dab551460f88] [2023-11-28] AL2023 6.1 Update ENA driver to 2.11.0g (darinzon@amazon.com)
  + [2758d59f3106] [2023-11-28] AL2023 6.1 Compile ENA driver with PHC flag (darinzon@amazon.com)
  + [84022f7cff5f] [2023-12-13] Revert "objtool: Propagate early errors" (apanyaki@amazon.com)
  + [52f809700c96] [2023-06-23] KVM: arm64: Enable writable for ID_AA64ISAR2_EL0 (surajjs@amazon.com)
  + [e82d04f17462] [2023-06-23] KVM: arm64: Enable writable for ID_AA64ISAR1_EL0 (surajjs@amazon.com)
  + [c61bce6fb752] [2023-06-22] KVM: arm64: Enable writable for ID_AA64ISAR0_EL0 (surajjs@amazon.com)
  + [10c5896000f4] [2023-06-07] KVM: arm64: Enable writable for ID_AA64MMFR{0, 1, 2}_EL1 (jingzhangos@google.com)
  + [a87f9596cf86] [2023-06-07] KVM: arm64: Enable writable for ID_AA64PFR0_EL1 (jingzhangos@google.com)
  + [ca0d75602aa1] [2023-06-07] KVM: arm64: Enable writable for ID_DFR0_EL1 (jingzhangos@google.com)
  + [33a6e24562ed] [2023-06-07] KVM: arm64: Enable writable for ID_AA64DFR0_EL1 (jingzhangos@google.com)
  + [db0b67cfe84d] [2023-06-02] KVM: arm64: Move non per vcpu flag checks out of kvm_arm_update_id_reg() (surajjs@amazon.com)
  + [64325996a463] [2023-06-02] KVM: arm64: Update id_reg limit value based on per vcpu flags (surajjs@amazon.com)
  + [32b230958408] [2023-06-02] KVM: arm64: Refactor writings for PMUVer/CSV2/CSV3 (jingzhangos@google.com)
  + [d632e03ad4d7] [2023-06-02] KVM: arm64: Reuse fields of sys_reg_desc for idreg (jingzhangos@google.com)
  + [32b39669962b] [2023-06-02] KVM: arm64: Use per guest ID register for ID_AA64DFR0_EL1.PMUVer (jingzhangos@google.com)
  + [c4f000d6eddf] [2023-06-02] KVM: arm64: Use per guest ID register for ID_AA64PFR0_EL1.[CSV2|CSV3] (jingzhangos@google.com)
  + [50e7ab6d1477] [2023-06-02] KVM: arm64: Save ID registers' sanitized value per guest (jingzhangos@google.com)
  + [8a99e89dfb5b] [2022-11-13] KVM: arm64: PMU: Allow ID_DFR0_EL1.PerfMon to be set from userspace (maz@kernel.org)
  + [3a034c54b94c] [2022-11-13] KVM: arm64: PMU: Allow ID_AA64DFR0_EL1.PMUver to be set from userspace (maz@kernel.org)
  + [4dbddae7789e] [2022-11-13] KVM: arm64: PMU: Move the ID_AA64DFR0_EL1.PMUver limit to VM creation (maz@kernel.org)
  + [0164d6b6fe10] [2022-11-13] arm64: Add ID_DFR0_EL1.PerfMon values for PMUv3p7 and IMP_DEF (maz@kernel.org)
  + [8faac2eb472c] [2023-10-31] AL2023-6.1-Update-ena-driver-to-2.10.0g (darinzon@amazon.com)
  + [d5f23e4ac586] [2023-10-22] Revert "perf/x86/amd/core: Fix overflow reset on hotplug" (shaoyi@amazon.com)
  + [5f4f938a0228] [2023-01-21] bpf: Fix partial dynptr stack slot reads/writes (memxor@gmail.com)
  + [4e5aa6260665] [2023-01-21] bpf: Fix missing var_off check for ARG_PTR_TO_DYNPTR (memxor@gmail.com)
  + [039caa2f93f1] [2023-01-21] bpf: Fix state pruning for STACK_DYNPTR stack slots (memxor@gmail.com)
  + [978267696557] [2022-12-08] bpf: Use memmove for bpf_dynptr_{read,write} (memxor@gmail.com)
  + [d337253b9559] [2022-12-08] bpf: Move PTR_TO_STACK alignment check to process_dynptr_func (memxor@gmail.com)
  + [28114543c38b] [2022-12-08] bpf: Rework check_func_arg_reg_off (memxor@gmail.com)
  + [e1db8d4c793d] [2022-12-08] bpf: Rework process_dynptr_func (memxor@gmail.com)
  + [1432eaf7dcfd] [2022-12-08] bpf: Propagate errors from process_* checks in check_func_arg (memxor@gmail.com)
  +