...
Source0: linux-6.1.102.tar
Source1: linux-6.1.102-patches.tar
...
%changelog
* Tue Aug 13 2024 Builder <builder@amazon.com>
- builder/b2c3cb3b25ecc8700ad14d14ad3cd9c4937faa90 last changes:
  + [b2c3cb3b25ec] [2024-08-13] Revert "patches/linux/amazon-6.1.y/mainline: Rebase to v6.1.103" (apanyaki@amazon.com)

- linux/0cc9380b8baf4af30477186c3e4e4865d7632b3e last changes:
  + [0cc9380b8baf] [2024-07-23] dma: Automatically enable page touching on Caspian (dwmw@amazon.co.uk)
  + [a305f73d722d] [2021-02-24] drivers/misc: sysgenid: add system generation id driver (acatan@amazon.com)
  + [6c3eff13cf7f] [2024-06-13] acpi: Support CONFIG_ACPI without CONFIG_PCI (surajjs@amazon.com)
  + [3ef5d71c19b0] [2024-04-17] virt: vmgenid: add support for devicetree bindings (sudanl@amazon.com)
  + [42044d80e6fd] [2024-04-17] virt: vmgenid: change implementation to use a platform driver (sudanl@amazon.com)
  + [06854f81501d] [2024-07-24] ptp: Add vDSO-style vmclock support (dwmw@amazon.co.uk)
  + [c01753661d53] [2024-07-12] AL2023-6.1-Update-ena-driver-to-2.12.3g (akiyano@amazon.com)
  + [61047e1bdee2] [2022-12-18] cifs: use origin fullpath for automounts (pc@cjr.nz)
  + [c3e9460b98da] [2024-06-05] arm64: mm: Batch dsb and isb when populating pgtables (ryan.roberts@arm.com)
  + [ffd4ba1b3282] [2024-06-05] arm64: mm: Don't remap pgtables per-cont(pte|pmd) block (ryan.roberts@arm.com)
  + [6ac0cfa90226] [2023-07-12] dma-contiguous: support numa CMA for specified node (yajun.deng@linux.dev)
  + [b550ef597492] [2023-05-12] dma-contiguous: support per-numa CMA for all architectures (yajun.deng@linux.dev)
  + [882f6b09ec93] [2024-03-11] arm64: acpi: Honour firmware_signature field of FACS, if it exists (dwmw@amazon.co.uk)
  + [bfbb9c17756a] [2024-03-11] ACPICA: Detect FACS even for hardware reduced platforms (dwmw@amazon.co.uk)
  + [71602cbf7206] [2024-03-11] arm64: Use SYSTEM_OFF2 PSCI call to power off for hibernate (dwmw@amazon.co.uk)
  + [ef7b90faaf95] [2024-03-18] firmware/psci: Add definitions for PSCI v1.3 specification (ALPHA) (dwmw@amazon.co.uk)
  + [acde68581171] [2024-01-05] x86/sev: Harden #VC instruction emulation somewhat (bp@alien8.de)
  + [a62739f160f1] [2024-03-19] AL2023-6.1-Update-ena-driver-to-2.12.0g (evostrov@amazon.com)
  + [f0d50273c74a] [2024-03-09] Initial 2.15 Lustre client commit (jacwolf@amazon.com)
  + [976cb578b481] [2024-03-09] Config glue for 2.15 Lustre client (jacwolf@amazon.com)
  + [982e9fead3f5] [2024-02-20] AL2023 6.1 Update EFA driver to 2.8.0 (mrgolin@amazon.com)
  + [11624d28eec7] [2024-02-07] AL2023-6.1-Update-ena-driver-to-2.11.1g (darinzon@amazon.com)
  + [21a0d0a04540] [2023-01-31] arm64: pauth: don't sign leaf functions (mark.rutland@arm.com)
  + [8a8f85527f00] [2023-11-28] AL2023 6.1 Update ENA driver to 2.11.0g (darinzon@amazon.com)
  + [75e0bdcea112] [2023-11-28] AL2023 6.1 Compile ENA driver with PHC flag (darinzon@amazon.com)
  + [1636ace31ddf] [2023-12-13] Revert "objtool: Propagate early errors" (apanyaki@amazon.com)
  + [bb8ac6e646f9] [2023-06-23] KVM: arm64: Enable writable for ID_AA64ISAR2_EL0 (surajjs@amazon.com)
  + [84842f0b72f5] [2023-06-23] KVM: arm64: Enable writable for ID_AA64ISAR1_EL0 (surajjs@amazon.com)
  + [d86236c82dee] [2023-06-22] KVM: arm64: Enable writable for ID_AA64ISAR0_EL0 (surajjs@amazon.com)
  + [200e6f7cc1c4] [2023-06-07] KVM: arm64: Enable writable for ID_AA64MMFR{0, 1, 2}_EL1 (jingzhangos@google.com)
  + [59246f2b504c] [2023-06-07] KVM: arm64: Enable writable for ID_AA64PFR0_EL1 (jingzhangos@google.com)
  + [2aa2253a70a5] [2023-06-07] KVM: arm64: Enable writable for ID_DFR0_EL1 (jingzhangos@google.com)
  + [37db09ed192b] [2023-06-07] KVM: arm64: Enable writable for ID_AA64DFR0_EL1 (jingzhangos@google.com)
  + [3bb4552cdafd] [2023-06-02] KVM: arm64: Move non per vcpu flag checks out of kvm_arm_update_id_reg() (surajjs@amazon.com)
  + [b8866403543c] [2023-06-02] KVM: arm64: Update id_reg limit value based on per vcpu flags (surajjs@amazon.com)
  + [27e397fed7e3] [2023-06-02] KVM: arm64: Refactor writings for PMUVer/CSV2/CSV3 (jingzhangos@google.com)
  + [ebdedeb92443] [2023-06-02] KVM: arm64: Reuse fields of sys_reg_desc for idreg (jingzhangos@google.com)
  + [1daedeb62fa7] [2023-06-02] KVM: arm64: Use per guest ID register for ID_AA64DFR0_EL1.PMUVer (jingzhangos@google.com)
  + [095eaade65ce] [2023-06-02] KVM: arm64: Use per guest ID register for ID_AA64PFR0_EL1.[CSV2|CSV3] (jingzhangos@google.com)
  + [19a0bca71638] [2023-06-02] KVM: arm64: Save ID registers' sanitized value per guest (jingzhangos@google.com)
  + [d98f9279961b] [2022-11-13] KVM: arm64: PMU: Allow ID_DFR0_EL1.PerfMon to be set from userspace (maz@kernel.org)
  + [6bd9c08b5b3b] [2022-11-13] KVM: arm64: PMU: Allow ID_AA64DFR0_EL1.PMUver to be set from userspace (maz@kernel.org)
  + [e255361ab336] [2022-11-13] KVM: arm64: PMU: Move the ID_AA64DFR0_EL1.PMUver limit to VM creation (maz@kernel.org)
  + [d5f099b9f7ed] [2022-11-13] arm64: Add ID_DFR0_EL1.PerfMon values for PMUv3p7 and IMP_DEF (maz@kernel.org)
  + [984ae2e62c2a] [2023-10-31] AL2023-6.1-Update-ena-driver-to-2.10.0g (darinzon@amazon.com)
  + [7cbcd24b916e] [2023-10-22] Revert "perf/x86/amd/core: Fix overflow reset on hotplug" (shaoyi@amazon.com)
  + [eb3f0845020f] [2023-01-21] bpf: Fix partial dynptr stack slot reads/writes (memxor@gmail.com)
  + [d079a4f782d9] [2023-01-21] bpf: Fix missing var_off check for ARG_PTR_TO_DYNPTR (memxor@gmail.com)
  + [051e8ca856fa] [2023-01-21] bpf: Fix state pruning for STACK_DYNPTR stack slots (memxor@gmail.com)
  + [1a8d8d1688d4] [2022-12-08] bpf: Use memmove for bpf_dynptr_{read,write} (memxor@gmail.com)
  + [70831a5803bf] [2022-12-08] bpf: Move PTR_TO_STACK alignment check to process_dynptr_func (memxor@gmail.com)
  + [5c2331d861d7] [2022-12-08] bpf: Rework check_func_arg_reg_off (memxor@gmail.com)
  + [36197e64ea76] [2022-12-08] bpf: Rework process_dynptr_func (memxor@gmail.com)
  + [df67558bffc8] [2022-12-08] bpf: Propagate errors from process_* checks in check_func_arg (memxor@gmail.com)
  + [285a0b53fba1] [2022-12-08] bpf: Refactor ARG_PTR_TO_DYNPTR checks into process_dynptr_func (memxor@gmail.com)
  + [6f6ee1953cf2] [2023-01-21] selftests/bpf: Add dynptr partial slot overwrite tests (memxor@gmail.com)
  + [5fc8afe22dd0] [2023-01-21] selftests/bpf: Add dynptr var_off tests (memxor@gmail.com)
  + [678970b79fa0] [2023-01-21] selftests/bpf: Add dynptr pruning tests (memxor@gmail.com)
  + [2d6ec45fffde] [2023-01-21] selftests/bpf: convenience macro for use with 'asm volatile' blocks (eddyz87@gmail.com)
  + [e09ea9c18e96] [2022-12-07] selftests/bpf: convert dynptr_fail and map_kptr_fail subtests to generic tester (andrii@kernel.org)
  + [2c859a48d2e6] [2022-12-07] selftests/bpf: add generic BPF program tester-loader (andrii@kernel.org)
  + [3cf05e1c6665] [2023-09-27] cgroup: add cgroup_favordynmods= command-line option (luizcap@amazon.com)
  + [a722fec7c93d] [2023-05-18] KVM: arm64: Prevent unconditional donation of unmapped regions from the host (will@kernel.org)
  + [09188819e93a] [2022-11-10] KVM: arm64: Prevent the donation of no-map pages (qperret@google.com)
  + [8d8349848709] [2022-11-15] arm64/sve: Leave SVE enabled on syscall if we don't context switch (broonie@kernel.org)
  + [d7088b5fe4e2] [2022-11-15] arm64/fpsimd: SME no longer requires SVE register state (broonie@kernel.org)
  + [4ec5338eecdf] [2022-11-15] arm64/fpsimd: Load FP state based on recorded data type (broonie@kernel.org)
  + [a9f91720194a] [2022-11-15] arm64/fpsimd: Stop using TIF_SVE to manage register saving in KVM (broonie@kernel.org)
  + [c14bd333a075] [2022-11-15] arm64/fpsimd: Have KVM explicitly say which FP registers to save (broonie@kernel.org)
  + [ecc194bb8b54] [2022-11-15] arm64/fpsimd: Track the saved FPSIMD state type separately to TIF_SVE (broonie@kernel.org)
  + [e36d70760c8f] [2022-11-15] KVM: arm64: Discard any SVE state when entering KVM guests (broonie@kernel.org)
  + [06f12886e262] [2023-08-08] AL2023 6.1 Update ena driver to 2.8.9g (darinzon@amazon.com)
  + [64d69cbd7d84] [2023-07-11] scripts/sign_file: Add option to keep signing certificate (samjonas@amazon.com)
  + [1f1bb3dff362] [2019-04-23] KEYS: Make use of platform keyring for module signature verify (robeholmes@gmail.com)
  + [285d81dd498a] [2023-02-09] Enable ptIOMMU for all supported platforms (daviddb@amazon.com)
  + [d29f4b37a42f] [2023-07-27] ip: Bump default ttl to 127. (kuniyu@amazon.com)
  + [44d1e043f2a7] [2022-11-18] mm: document /sys/class/bdi/<bdi>/strict_limit knob (shr@devkernel.io)
  + [8ba664eb9639] [2022-11-18] mm: add knob /sys/class/bdi/<bdi>/strict_limit (shr@devkernel.io)
  + [5c1bf1eedaf5] [2022-11-18] mm: add bdi_set_strict_limit() function (shr@devkernel.io)
  + [938d28224d5f] [2023-06-09] KEYS: use kfree_sensitive with key (mngyadam@amazon.com)
  + [b8924e55c701] [2023-06-23] crypto: ecc - Add SP800-56A rev 3 Pair-wise Consistency check (mngyadam@amazon.com)
  + [ee150deba33d] [2023-06-23] crypto: dh - Add SP800-56A rev 3 Pair-wise Consistency check (mngyadam@amazon.com)
  + [55a2ea0e63f9] [2023-03-03] crypto: rng - Use a different crypto_rng for reseeding (herbert.xu@redhat.com)
  + [99c469d0bc55] [2022-08-03] random: allow reseeding DRBG with getrandom (dueno@redhat.com)
  + [15a931a1b833] [2023-02-14] net/ipv6: Improve performance of inet6_ehashfn() (trawets@amazon.com)
  + [69a1dca03f16] [2023-06-17] crypto: tcrypt.c - Add selftest for ffdhe algorithims (hailmo@amazon.com)
  + [b87a68e8dda1] [2023-06-09] crypto: Only allow GCM in FIPS when instantiated via seqiv (samjonas@amazon.com)
  + [67d18b2579e9] [2023-06-06] crypto: rsa - allow only odd e and restrict value in FIPS mode (mngyadam@amazon.com)
  + [b56d858cbee2] [2021-08-10] crypto: rng - Override drivers/char/random in FIPS mode (herbert.xu@redhat.com)
  + [8059f77a4c2b] [2021-08-10] random: Add hook to override device reads and getrandom(2) (herbert.xu@redhat.com)
  + [03f85b6efeb2] [2023-04-13] Revert "drm: fb_helper: improve CONFIG_FB dependency" (samjonas@amazon.com)
  + [a082ae19325a] [2023-06-06] crypto: ecdh - zeroize crpytographic keys after use (hailmo@amazon.com)
  + [f0e8b9b9b863] [2023-06-06] crypto: testmgr - Remove xts4096(paes) and xts512(paes) (hailmo@amazon.com)
  + [0f2a6f587d97] [2023-04-21] crypto: jitter - replace LFSR with SHA3-256 (smueller@chronox.de)
  + [013b1cb33c6d] [2022-12-29] crypto: testmgr - disallow plain ghash in FIPS mode (nstange@suse.de)
  + [96f6905f31f6] [2022-12-29] crypto: testmgr - disallow plain cbcmac(aes) in FIPS mode (nstange@suse.de)
  + [7f3a272be9e0] [2023-01-17] crypto: testmgr - disallow certain DRBG hash functions in FIPS mode (vdronov@redhat.com)
  + [807cab9b1598] [2021-11-02] arm64: module: Use aarch64_insn_write when updating relocations later on (surajjs@amazon.com)
  + [22fe910f5e68] [2021-05-03] arm64: implement live patching (surajjs@amazon.com)
  + [18f84870e307] [2023-02-02] arm64: Define HAVE_DYNAMIC_FTRACE_WITH_ARGS (madvenka@linux.microsoft.com)
  + [3897553a3f5d] [2021-03-15] arm64: Implement arch_stack_walk_reliable() (madvenka@linux.microsoft.com)
  + [c5dc0304b0db] [2021-05-26] erm64: Create a list of SYM_CODE functions, check return PC against list (madvenka@linux.microsoft.com)
  + [a9ee8f626263] [2021-05-26] arm64: Introduce stack trace reliability checks in the unwinder (madvenka@linux.microsoft.com)
  + [a1bdd16225b2] [2021-10-15] arm64: kvm: vgic-v3-sr: Bug when trying to read invalid APRs (surajjs@amazon.com)
  + [b8cec191de15] [2022-06-23] arm64: kernel: Skip validation of proton-pack.c (chenzhongjin@huawei.com)
  + [43e3f508b46f] [2022-06-23] arm64: entry: Align stack size for alternative (chenzhongjin@huawei.com)
  + [531ff1bb9afe] [2022-06-23] arm64: sleep: Properly set frame pointer before call (chenzhongjin@huawei.com)
  + [d28c228328ea] [2022-06-23] arm64: Set intra-function call annotations (chenzhongjin@huawei.com)
  + [70edc3fae0c5] [2022-06-23] arm64: crypto: Remove unnecessary stackframe (chenzhongjin@huawei.com)
  + [c161884b3694] [2022-06-23] arm64: crypto: Mark constant as data (chenzhongjin@huawei.com)
  + [28141e51914f] [2022-06-23] arm64: head: Mark constants as data (chenzhongjin@huawei.com)
  + [723ee5cb3ff1] [2022-06-23] arm64: efi-header: Mark efi header as data (chenzhongjin@huawei.com)
  + [6c1c57b93932] [2022-06-23] arm64: kvm: Annotate unwind_hint for hyp entry (chenzhongjin@huawei.com)
  + [6574ff39f1bf] [2022-06-23] arm64: entry: Annotate unwind_hint for entry (chenzhongjin@huawei.com)
  + [d19dbe6b9821] [2022-06-23] arm64: Annotate unwind_hint for symbols with empty stack (chenzhongjin@huawei.com)
  + [32692632afc7] [2022-06-23] arm64: Change symbol type annotations (chenzhongjin@huawei.com)
  + [67c4111a0535] [2022-06-23] objtool: arm64: Add unwind_hint support (chenzhongjin@huawei.com)
  + [3fccb02b150f] [2022-06-23] arm64: kgdb: Add reachable annotation after kgdb brk (chenzhongjin@huawei.com)
  + [cf11c61f3f90] [2022-06-23] arm64: bug: Add reachable annotation to warning macros (chenzhongjin@huawei.com)
  + [68aa5aa6a2bd] [2022-06-23] objtool: arm64: Add annotate_reachable() for objtools (chenzhongjin@huawei.com)
  + [d291d6a30340] [2023-03-28] Revert "arm64: alternatives: add shared NOP callback" (surajjs@amazon.com)
  + [1bf0b6217e13] [2022-06-23] objtool: arm64: Enable stack validation for arm64 (chenzhongjin@huawei.com)
  + [25ec317014f8] [2022-06-23] objtool: arm64: Ignore replacement section for alternative callback (chenzhongjin@huawei.com)
  + [c498b5badf33] [2022-06-23] objtool: arm64: Handle supported relocations in alternatives (chenzhongjin@huawei.com)
  + [8db4223a8cb1] [2022-06-23] objtool: check: Support data in text section (chenzhongjin@huawei.com)
  + [7f9031cac239] [2022-06-23] objtool: arm64: Accept non-instruction data in code sections (chenzhongjin@huawei.com)
  + [9023c59565cb] [2022-06-23] objtool: arm64: Decode LDR instructions (chenzhongjin@huawei.com)
  + [21ff846cd9ca] [2022-06-23] objtool: arm64: Decode load/store instructions (chenzhongjin@huawei.com)
  + [788c967de7d5] [2022-06-23] objtool: arm64: Decode other system instructions (chenzhongjin@huawei.com)
  + [4dba06dbc631] [2022-06-23] objtool: arm64: Decode jump and call related instructions (chenzhongjin@huawei.com)
  + [8bbf9f7b9926] [2022-06-23] objtool: arm64: Decode add/sub instructions (chenzhongjin@huawei.com)
  + [ca748c897d9a] [2022-06-23] objtool: arm64: Add base definition for arm64 backend (chenzhongjin@huawei.com)
  + [fcfda8e32408] [2022-06-23] tools: arm64: Make aarch64 instruction decoder available to tools (chenzhongjin@huawei.com)
  + [9b5aae90b322] [2023-03-14] objtool: Specify host-arch for making LIBSUBCMD (surajjs@amazon.com)
  + [b69da26f6d59] [2023-03-14] objtool: Add generic symbol for relocation type (surajjs@amazon.com)
  + [0aacecb20fd4] [2023-05-17] AL2023 6.1 Update ena driver to 2.8.6g (akiyano@amazon.com)
  + [2a32cd75b34a] [2023-04-14] Revert "selinux: runtime disable is deprecated, add some ssleep() discomfort" (luizcap@amazon.com)
  + [b25f7af38de5] [2023-03-30] ENA: Update to v2.8.3 (samjonas@amazon.com)
  + [ebbd3385034e] [2023-03-03] udp: Fix memleaks of sk and zerocopy skbs with TX timestamp. (kuniyu@amazon.com)
  + [21381d498975] [2023-03-20] msr: disable MSR writes by default (luizcap@amazon.com)
  + [206b2798fb31] [2023-01-24] Revert "xen/x2apic: enable x2apic mode when supported for HVM" (samjonas@amazon.com)
  + [0db62d1e10d8] [2023-01-20] Revert "PCI/MSI: Let core code free MSI descriptors" (samjonas@amazon.com)
  + [939f1b741855] [2019-11-27] block/xen-blkfront: bump the maximum number of indirect segments up to 64 (fllinden@amazon.com)
  + [f770a3e66cb0] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [df7608094dec] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [b4a888e254ce] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [9593fd676f10] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [53ff1edbdb97] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [7d151743b4bb] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [f5b8c0d0c8e7] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [2ae2517b383c] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [fd5de3c833c9] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [4978d304c0fa] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [9df9ffac4225] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [df1580a8a447] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [af9e807477b5] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [c24b7452f383] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [4dff0e82d323] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [70ac6e9a3d34] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [0e9415b2192e] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [64c3887a3569] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [105852422369] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [f909819b17fe] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [4aaf96141555] [2017-10-27] Enable Algorithims for Amazon Linux 6.1.y (alakeshh@amazon.com)
  + [1b4e0e67ea01] [2023-01-10] EFA: Update to v2.1.1 (shaoyi@amazon.com)
  + [1cc1f424e94d] [2023-01-10] ENA: Update to v2.8.1 (shaoyi@amazon.com)
  + [e00b5dbceceb] [2023-01-10] drivers/amazon: import 5.15 drivers (shaoyi@amazon.com)
  + [5ef2f09541ce] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [ea2dd9600a60] [2021-02-22] hwrng: Add Gravition RNG driver (vaerov@amazon.com)
  + [c21f32d7a198] [2021-02-22] arm64: Export acpi_psci_use_hvc() symbol (vaerov@amazon.com)
  + [2c22f3225d15] [2021-05-12] x86: Disable KASLR when Xen is detected (benh@amazon.com)
  + [763007c7b9cc] [2022-05-25] Correct read overflow in page touching DMA ops binding (tbarri@amazon.com)
  + [ac8b477833e0] [2021-09-17] Introduce page touching DMA ops binding (jgowans@amazon.com)
  + [9755ac340d50] [2021-12-10] virtio-balloon: optionally report offlined memory ranges (fllinden@amazon.com)
  + [6babfab408ab] [2022-01-06] virtio: add hack to allow pre-mapped scatterlists (fllinden@amazon.com)
  + [17faa28e50a0] [2022-01-06] mm: add offline page reporting interface (fllinden@amazon.com)
  + [5864ffbdfb4f] [2021-12-09] drivers/base/memory: use MHP_MEMMAP_ON_MEMORY from the probe interface (fllinden@amazon.com)
  + [2da7c162ccca] [2021-12-31] memory: fix offline_and_remove_memory use (fllinden@amazon.com)
  + [290df10a9671] [2021-07-14] arm64/mm: Enable sysfs based memory hot remove probe (rohiwali@amazon.com)
  + [2ccc3dcadeee] [2019-04-03] Sysfs memory probe interface (anshuman.khandual@arm.com)
  + [22f86aa25777] [2021-09-15] mm, memcg: throttle the memory reclaim given dirty/writeback pages to avoid early OOMs (shaoyi@amazon.com)
